...
Permets d’afficher du texte à l’écran. 
Prend un string donné en paramètre ainsi que la position du texte a l'écran
et à l'aide de la méthode draw le dessine
--------------------------------------------------*/
